<html lang="en">
 ...
 <body class="font-roboto bg-gray-100">
  ...
  <section class="relative">
    <img alt="Surfer riding a wave" class="w-full h-[600px] object-cover" height="800" src="https://storage.googleapis.com/a1aa/image/l9Ns5otAen0lYibe71ywfioxmfds9WDSpwhOhDKjMbNSkN5PB.jpg" width="1920"/>
    <div class="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
    <div class="bg-white bg-opacity-50 p-4 mt-4 rounded">
        <h1 class="text-4xl md:text-6xl font-bold text-teal-800">
            Selamat Datang di LAPAKKU
           </h1><br>
           <h2 class="text-black">
            Temukan UMKM khas Desa Ketanen disini. Dari yang unik hingga Epic. All in one in here!!.
           </h2>
    </div>
    ...
    <div class="container mx-auto text-center">
     ...
     <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
      <a href="isiproduk.php"  class="bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
       <img href="isiproduk.php" alt="Gambar produk 1" class="w-full h-48 object-cover rounded-t-lg" height="200" src="https://storage.googleapis.com/a1aa/image/TYymQVImLS6UE1AgX9xX8LxUFYH5qVlUb1iXen0RLeqBZTenA.jpg" width="300"/>
