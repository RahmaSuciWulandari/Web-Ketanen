...
<body class="bg-gray-50 p-4">
    <div class="max-w-8xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <!-- Title Section -->
        <h1 class="text-3xl font-bold mb-2">Produk 1</h1>
        <p class="text-gray-600 mb-6">
            Dsn. XX Rt. xx Rw. xx
            <a class="text-blue-500 font-medium hover:underline" href="#">Lihat Lapak</a>
        </p>
        <!-- Content Section -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Information Section -->
            <div>
                <h2 class="text-xl font-bold mb-4">Informasi Produk 1</h2>
        ...
        <!-- Facilities Section -->
        <div class="mt-8">
            <h2 class="text-xl font-bold mb-4">Keunggukalan Produk UMKM</h2>
            <div class="grid grid-cols-2 gap-4">
                <div class="flex items-center">
                    <i class="fas fa-bed text-2xl text-gray-600 mr-4"></i>
                    <span class="text-gray-700">Halal Sertification</span>
                </div>
                <div class="flex items-center">
                    <i class="fas fa-utensils text-2xl text-gray-600 mr-4"></i>
                    <span class="text-gray-700">Great Quality</span>
                </div>
                <div class="flex items-center">
                    <i class="fas fa-binoculars text-2xl text-gray-600 mr-4"></i>
                    <span class="text-gray-700">Strong Branding</span>
                </div>
            </div>
        </div>
        <!-- Save and Review Section -->
        <div class="mt-8">
            <button class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-medium shadow">
                Beli Jajan
            </button>
        </div>
    </div>
